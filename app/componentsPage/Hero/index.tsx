            ...
            <div className="flex items-center h-full pt-4">
              <div className="flex flex-col md:gap-12 gap-12">
                ...
                <span
                  ...
                  className="flex md:text-xl items-center cursor-pointer text-yellow-500 underline underline-offset-4" //py-4 px-8 rounded-full border border-yellow-600 md:w-fit
                >
                  <GradientText
                    colors={["#EAB308"]}
                    animationSpeed={3}
                  ...
                  {/* <FaArrowRight className="ml-4 text-yellow-500 animate-moveRight " /> */}
                </span>
              </div>
            </div>
          </div>
